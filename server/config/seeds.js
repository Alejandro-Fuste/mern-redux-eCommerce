...
db.once("open", async () => {
  ...
  await User.create({
    firstName: "Luke",
    lastName: "Skywalker",
    email: "luke.skywalker@testmail.com",
    password: "password12345",
  });
